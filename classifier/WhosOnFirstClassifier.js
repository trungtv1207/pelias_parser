...
const placetypes = {
  ...
  'county': {
    files: ['name:vie_x_preferred.txt', 'name:vie_x_preferred_NFD.txt', 'name:vie_x_preferred_prefix.txt', 'name:vie_x_preferred_prefix_NFD.txt'],
    classifications: [AreaClassification, CountyClassification]
  },
  'region': {
    files: ['abrv:eng_x_preferred.txt', 'name:eng_x_preferred.txt', 'name:vie_x_preferred.txt', 'name:vie_x_preferred_NFD.txt', 'name:vie_x_preferred_prefix.txt', 'wof:shortcode.txt'],
  ...
  // },
  'country': {
    files: ['name:eng_x_preferred.txt', 'wof:country.txt', 'wof:country_alpha3.txt', 'wof:shortcode.txt'],
    classifications: [AreaClassification, CountryClassification]
  },
  'street': {
    files: ['name:vie_x_preferred.txt', 'name:vie_x_preferred_prefix.txt', 'name:vie_x_preferred_NFD.txt', 'name:vie_x_preferred_prefix_NFD.txt'],
